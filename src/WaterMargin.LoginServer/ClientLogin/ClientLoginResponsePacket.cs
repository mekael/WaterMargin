...
namespace WaterMargin.LoginServer.Logic.ClientLogin
{
    public class ClientLoginResponsePacket
    {
        ...
        public List<GameServerItem> Servers { get; set; }
        ...
        public ClientLoginResponsePacket(int sessionId, List<GameServerItem> servers)
        {
        ...
        public void Update(int sessionId, List<GameServerItem> servers)
        {
            this.SessionId = sessionId;
            this.Servers = servers;
