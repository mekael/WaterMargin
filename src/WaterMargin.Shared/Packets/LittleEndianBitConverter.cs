...
// Blatantly stolen from L2Dn private server project

public readonly struct LittleEndianBitConverter 
{
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static T ToValue<T>(ReadOnlySpan<byte> value) where T : unmanaged =>
        BitConverterHelper.ToValueLittleEndian<T>(value);
    ...
    public static void WriteValue<T>(Span<byte> destination, T value)
        where T : unmanaged =>
        BitConverterHelper.WriteValueLittleEndian(destination, value);
    ...
    public static bool TryWriteValue<T>(Span<byte> destination, T value)
        where T : unmanaged =>
        BitConverterHelper.TryWriteValueLittleEndian(destination, value);
